...
> - 在线翻译器需要配置 API Key → [API 配置教程](API_CONFIG.md)
...
- 🔧 **自定义提示词**：支持自定义翻译风格和术语表 → [设置说明](SETTINGS.md#如何添加高质量提示词)

### 配置在线翻译器

需要配置 API Key 的翻译器，请查看详细配置教程：

**📚 API 配置教程** → [API 配置教程](API_CONFIG.md)
...
**添加自定义字体**：详见 [设置说明](SETTINGS.md#如何添加自定义字体)
